...
/// Byte-crypto adapter for V2 attachments.
///
/// Files, streams and retry state stay in Flutter; every descriptor, chunk and
/// manifest calculation is delegated to the frozen standalone SDK.
class SdkV2AttachmentCryptoService extends AttachmentCryptoService {
  SdkV2AttachmentCryptoService({sdk.PqcV2Engine? engine})
