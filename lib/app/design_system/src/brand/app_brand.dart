...
class AppSkinRegistry {
  ...
  static const Map<String, AppSkin> skins = {
    defaultSkinId: AppSkin(
      ...
      appTitle: 'antiQ',
      wordmark: 'antiQ',
      seedColor: Color(0xFF2D5BCE),
      primaryColor: Color(0xFF4D7CFE),
      secondaryColor: Color(0xFF91A4C4),
      backgroundColor: Color(0xFFF5F5F7),
      surfaceColor: Color(0xFFFFFFFF),
      surfaceMutedColor: Color(0xFFEFF3F9),
      successColor: Color(0xFF28A879),
      warningColor: Color(0xFFD7A33D),
      dangerColor: Color(0xFFE05A67),
    ),
